...
import graPayeScheduleRoutes from "./routes/gra-paye-schedule.route.js";
import sshfcRemittanceRoutes from "./routes/sshfc-remittance.route.js";
import overtimeApprovalRoutes from "./routes/overtime-approval.route.js";
...
app.use("/api/gra-paye-schedules", graPayeScheduleRoutes);
app.use("/api/sshfc-remittances", sshfcRemittanceRoutes);
app.use("/api/payroll/overtime-approvals", overtimeApprovalRoutes);
