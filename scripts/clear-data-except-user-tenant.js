/**
 * Empties all data in the database except User, Tenant, Session, and Account.
...
async function main() {
  console.log("Clearing all data except User, Tenant, Session, and Account...");
  ...
  console.log("Done. User, Tenant, Session, and Account are unchanged. You can still log in.");
}
